<?php
/**
 * AC El I Karlskrona AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "AC El I Karlskrona AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through ac_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'acelikarlskrona', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'acelikarlskrona' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'acelikarlskrona' ) ) );

		register_block_pattern_category( 'acelikarlskrona-sections', array( 'label' => __( 'AC El I Karlskrona AB sections', 'acelikarlskrona' ) ) );
		register_block_pattern_category( 'acelikarlskrona-pages', array( 'label' => __( 'AC El I Karlskrona AB page layouts', 'acelikarlskrona' ) ) );
	}
);

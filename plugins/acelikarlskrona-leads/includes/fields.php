...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'acelikarlskrona-leads' ),
				'storm'       => __( 'Storm or hail damage', 'acelikarlskrona-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'acelikarlskrona-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'acelikarlskrona-leads' ),
				'not-sure'    => __( 'Vet inte än', 'acelikarlskrona-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'acelikarlskrona-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'acelikarlskrona-leads' ),
				'research' => __( 'Jag kollar bara priser', 'acelikarlskrona-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'acelikarlskrona-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'acelikarlskrona-leads' ),
		'contacted' => __( 'Kontaktad', 'acelikarlskrona-leads' ),
		'quoted'    => __( 'Quote sent', 'acelikarlskrona-leads' ),
		'won'       => __( 'Won', 'acelikarlskrona-leads' ),
		'lost'      => __( 'Lost', 'acelikarlskrona-leads' ),
		'spam'      => __( 'Misstänkt spam', 'acelikarlskrona-leads' ),
	);
}

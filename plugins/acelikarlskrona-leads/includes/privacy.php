...
add_filter(
	...
	function ( $exporters ) {
		$exporters['acelikarlskrona-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'acelikarlskrona-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'acelikarlskrona-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'acelikarlskrona-leads',
						'group_label' => __( 'Quote requests', 'acelikarlskrona-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['acelikarlskrona-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'acelikarlskrona-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {

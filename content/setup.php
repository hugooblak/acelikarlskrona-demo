<?php
/**
 * Demo site setup for AC El I Karlskrona AB.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'AC El I Karlskrona AB' );
...
$home = nps_page(
	...
	nps_pattern( 'acelikarlskrona/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'acelikarlskrona/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'acelikarlskrona/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'acelikarlskrona/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'acelikarlskrona/thank-you' ),
...
<p class="has-large-font-size">AC El I Karlskrona AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om AC El I Karlskrona AB', $about_content . "\n\n" . nps_pattern( 'acelikarlskrona/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'acelikarlskrona/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder AC El I Karlskrona AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'AC El I Karlskrona AB demo ready.' );
